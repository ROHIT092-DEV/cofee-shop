          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-6">
                ...
                <p className="text-lg md:text-xl text-orange-700 animate-fadeInUp animate-delay-100">
              ...
              <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto text-gray-700 leading-relaxed animate-fadeInUp animate-delay-200">
                Discover our handcrafted beverages, artisanal pastries, and
                gourmet sandwiches.
              </p>
            ...
            {!user && products.length > 0 && (
              <div className="text-center mt-8 bg-amber-50 rounded-lg p-6">
                ...
                <p className="text-gray-600 mb-4 max-w-lg mx-auto">
                  Join our coffee community and start ordering your favorites
                  today!
                </p>
                <Link
                  href="/register"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-slideInLeft animate-delay-100">
                <div className="text-3xl mb-3 hover:scale-110 transition-transform duration-200">
                  🔐
                </div>
                ...
                <p className="text-gray-600 text-sm">
                  Safe and secure authentication for all users
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-fadeInUp animate-delay-200">
                ...
                <p className="text-gray-600 text-sm">
                  Simple cart system with real-time calculations
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-slideInRight animate-delay-100">
                ...
                <p className="text-gray-600 text-sm">
                  Real-time inventory with fresh products daily
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-slideInLeft animate-delay-300">
                ...
                <p className="text-gray-600 text-sm">
                  Discover what's popular with other customers
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-fadeInUp animate-delay-400">
                ...
                <p className="text-gray-600 text-sm">
                  Curated featured products for the best experience
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 animate-slideInRight animate-delay-300">
                ...
                <p className="text-gray-600 text-sm">
                  Perfect experience on all devices and screens
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {featuredProducts.map((product) => (
                  <div
                    key={product._id}
                    className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden border border-purple-200"
                  >
                    <div className="p-4">
                      <div className="flex justify-between items-start mb-3">
                        <span className="bg-purple-100 text-purple-600 px-2 py-1 rounded text-xs font-medium">
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {trendingProducts.map((product, index) => (
                  <div
                    key={product._id}
                    className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden border border-red-200"
                  >
                    <div className="p-4">
                      <div className="flex justify-between items-start mb-3">
          ...
          <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <div className="text-gray-400 space-y-2 text-sm">
                  <p className="flex items-center">
                    <span className="mr-2">📍</span> 123 Coffee Street, Bean
                    City
                  </p>
                  <p className="flex items-center">
                    <span className="mr-2">📞</span> (555) 123-CAFE
                  </p>
                  <p className="flex items-center">
                    <span className="mr-2">✉️</span> hello@coffeeshop.com
                  </p>
                  <p className="flex items-center">
                    <span className="mr-2">🕒</span> Mon-Sun: 6AM - 10PM
                  </p>
                </div>
              </div>
            </div>
            <div className="border-t border-gray-800 mt-8 pt-6 text-center">
              <p className="text-gray-400 text-sm">
                &copy; 2024 Coffee Shop. Made with ❤️ for coffee lovers.
              </p>
            </div>
          </div>
        </footer>
